...
const destinations = [
  {
    ...
    description: "Ancient rock fortress and palace ruins surrounded by gardens, ponds and other structures"
  },
  {
    id: 2,
    name: "Ella",
    ...
    description: "Picturesque hill town known for tea plantations, hiking trails and scenic train rides"
  },
  {
    id: 3,
    name: "Galle Fort",
    ...
    description: "Historic 17th century Dutch fort with cobblestone streets and colonial architecture"
  },
  {
    id: 4,
    name: "Mirissa Beach",
